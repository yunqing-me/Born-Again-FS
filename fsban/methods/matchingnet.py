...
class MatchingNet(MetaTemplate):
    def __init__(self, model_func, n_way, n_support, teacher=None, tf_path=None):
        super(MatchingNet, self).__init__(model_func, n_way, n_support, teacher=teacher, tf_path=tf_path)
